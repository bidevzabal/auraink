...
export default function Navigation({ children }: { children: React.ReactNode; }) {
    ...
    return (
        <div className="flex items-center justify-center gap-12">
                        ...
                        <motion.dialog
                            ...
                            <div className="fixed bottom-20 sm:bottom-32 left-4 sm:left-8 flex flex-col items-start justify-center gap-4">
                                ...
                                <motion.button
                                    ...
                                    className="w-fit flex items-center justify-center gap-3 text-lg sm:text-2xl text-black cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" aria-hidden>
            ...
            <button type="button" onClick={() => setIsOpen(prev => !prev)} className="w-6 sm:w-8 h-fit text-black cursor-pointer hover:outline-2 focus-visible:outline-2 outline-offset-1  focus-visible:outline-white rounded-lg">
...
function MobileLink({ href, className, children }: MobileLinkProps) {
    return (
        <motion.a
            ...
            animate={{ transform: "translateY(0px)", filter: "blur(0px)", opacity: 1 }}
            exit={{ transform: "translateY(100px)", filter: "blur(20px)", opacity: 0 }}
            className={clsx("w-fit flex items-center justify-center gap-3 text-lg sm:text-2xl text-black cursor-pointer", className)}>
            {children}
        </motion.a>
    );
}